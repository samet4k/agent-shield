...
pub async fn analyze_via_daemon(params: AnalyzeParams) -> Result<AnalyzeResult> {
    ...
    serde_json::from_value(resp.result.context("empty result")?).context("decode analyze result")
}
